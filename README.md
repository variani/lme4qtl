...
Note that rownames/colnames of `myMatrix` have to be values if `myID` variable, so matching between relationship matrix and grouping variable is possible. The order doesn't matter.
